...
To install a specific version of the operator theoretically we could use `startingCSV: amq-broker-operator.v7.10.2-opr-2-0.1676475747.p` in the `Subscription`.
